...
public class Block extends JComponent {
    ...
    protected void paintComponent(Graphics pinceau) {
        ...
        if (carac == Defines.BLOCK_GREEN_CHARAC) {
            // Vert
            imagePath = Defines.BLOCK_GREEN_IMAGE;
        }
        else if (carac == Defines.BLOCK_BLUE_CHARAC) {
            // Bleu
            imagePath = Defines.BLOCK_BLUE_IMAGE;
        }
        else if (carac == Defines.BLOCK_RED_CHARAC) {
            // Rouge
            imagePath = Defines.BLOCK_RED_IMAGE;
        }
        else if (carac == Defines.BLOCK_EMPTY_CHARAC) {
            // Vide
